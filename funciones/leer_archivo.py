...
def unificar_archivos(LONGITUD_PALABRA):
    with open("../utiles/Cuentos.txt", "r", encoding="utf-8") as archivo_entrada1, \
            open("../utiles/La araña negra - tomo 1.txt", "r", encoding="utf-8") as archivo_entrada2, \
            open("../utiles/Las 1000 Noches y 1 Noche.txt", "r", encoding="utf-8") as archivo_entrada3, \
            open("../archivos_generados/palabras.csv", "w", encoding="utf-8") as archivo_salida:
