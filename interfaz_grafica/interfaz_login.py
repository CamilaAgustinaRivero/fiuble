...
def ventana_login(modo_de_juego):
    ...
    if modo_de_juego == 2:
        ...
        botonEnvio=Button(marco, text="Entrar", command=lambda:verificar_ingreso_clave(entry_user1.get(), entry_pw1.get(), modo_de_juego, entry_user2.get(), entry_pw2.get()))
    else:
        entry_user1, entry_pw1 = casilla_usuario_y_clave(1, 0, marco)
        botonEnvio=Button(marco, text="Entrar", command=lambda:verificar_ingreso_clave(entry_user1.get(), entry_pw1.get(), modo_de_juego))
