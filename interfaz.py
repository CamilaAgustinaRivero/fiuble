...
def ventana_login():
    ...
    #Casilla de Usuario
    mensaje_user = Label(marco, text="Usuario Alumno: ")
    ...
    botonEnvio=Button(marco, text="Enviar Formulario", command=lambda:validar_clave(entry_user.get(),entry_pw.get()))
